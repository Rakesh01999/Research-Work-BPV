...
type \\textit{easyBike} were simulated over a 600-second period, producing 33,708
...
strongly with $\text{R}^2 = 0.9992$ and $\text{MAE} = 8.30$~kW.
...
\hline
Total records                & 33,708 \\
Number of features           & 25 \\
Unique vehicles              & 49 \\
Simulation duration (s)      & 1 -- 600 \\
Status: Driving              & 18,478 (54.8\%) \\
Status: Charging             & 12,708 (37.7\%) \\
Status: Waiting              & 1,875 (5.6\%) \\
Status: Idle                 & 647 (1.9\%) \\
System load: Minimum (kW)    & 0.00 \\
System load: Mean (kW)       & 963.49 \\
System load: Maximum (kW)    & 1,340.00 \\
System load: Std. Dev. (kW)  & 380.95 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
stations. The mean system load was 963.49~kW, with a peak of 1,340~kW achieved when up
...
\textit{driving} status (54.8\%), followed by \textit{charging} (37.7\%), \textit{waiting}
(5.6\%), and \textit{idle} (1.9\%). This distribution reflects the expected behavior: most
...
XGBoost            & 0.0003 & 0.0003 & 1.0000 \\
Linear Regression  & 8.3024 & 10.8872 & 0.9992 \\
\hline
\end{tabular}
\end{center}
\end{table}
