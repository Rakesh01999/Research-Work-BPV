...
Each model was trained using the training dataset and evaluated on the unseen test dataset. Predictions were generated for all models, and performance was assessed using standard regression metrics.

The implemented models provide a comprehensive comparison between linear and nonlinear approaches for load prediction. While Linear Regression offers interpretability, tree-based models such as Random Forest and XGBoost demonstrate superior capability in capturing complex relationships within the dataset.

\begin{quote}
    ``The near-perfect performance of tree-based models indicates that the dataset exhibits strong deterministic relationships between system variables and load demand.''
\end{quote}
