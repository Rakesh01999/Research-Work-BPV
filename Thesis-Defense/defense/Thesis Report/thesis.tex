...
Linear Regression  & 8.5746 & 11.2403 & 0.9991 \\
\hline
\end{tabular}
\end{center}
\end{table}
...
\Gls{lr} achieved a lower (though still excellent) performance with an \Gls{mae} of 8.57~kW and an \Gls{rmse} of 11.24~kW. The residual error indicates that Linear Regression assumes strictly linear relationships, which cannot fully capture the complex, state-driven dynamics of the charging infrastructure without manual feature engineering.
