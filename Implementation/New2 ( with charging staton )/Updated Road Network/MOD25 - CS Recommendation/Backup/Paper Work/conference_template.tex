...
\and
\IEEEauthorblockN{Md. Mahmudul Amin Shakil}
\IEEEauthorblockA{\textit{Department of Computer Science \& Engineering}\\
\textit{Jashore University of Science and Technology (JUST)}\\
Jashore, Bangladesh\\
200106.cse@student.just.edu.bd}
}
...
Electric-Rickshaws and Electric-Vans -all over the Khulna city of
...
forecasting and smart grid planning studies within the emerging Electric
Vehicle ecosystem.
\end{abstract}
...
and E-Rickshaws -- have become the main intercity transportation medium.
...
failures. This results repair costs and disruption of driver service. In
...
electricity grid is projected to reach 780 TWh by 2030 \cite{b3}
...
advanced-economic contexts where vehicles are freely routable and have
...
in terms of capacity, power rating and geographical distribution. This
...
Rickshaws, Electric Vans) on 8 road-routes. It monitors real time
...
Wang et al. \cite{b2} formulated charging station selection as a
...
coordination gaps, which are directly correlated to this study.

\subsection{Real-Time Routing and AI-Based Selection}

Current research explored reinforcement learning \& AI based frameworks
for dynamics Electric Vehicle charging distribution. These methods
target to balance the load at stations, to lessen traffic, decrease
peak-demand through adaptive routing suggestion. Microscopic traffic
...
mobility modeling. By the way fixed work aggregated real time suggestive
...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=0.9\columnwidth]{System_Architecture.png}}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.48\columnwidth}
    \centering
    \includegraphics[width=\linewidth]{Khulna_city_OSM.png}
    \caption{}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\columnwidth}
    \centering
    \includegraphics[width=\linewidth]{Road_Network.png}
    \caption{}
  \end{subfigure}
...
efficiency, and 64\% recovery efficiency. Table~\ref{tab:fleet}
...
the multi-criteria scoring model widely distributes demand.
...
\bibitem{b22}
``Electric vehicle and sustainable transport in South Asia,'' UNESCAP,
2022. [Online]. Available:
\url{https://www.unescap.org/sites/default/d8files/event-documents/Day1-8Ahsanullah-University-Science-Technology.pdf}
